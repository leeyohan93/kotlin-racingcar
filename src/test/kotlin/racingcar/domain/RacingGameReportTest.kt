        ...
        context("마지막 랩에 가장 많이 움직인 자동차를 우승자로 조회할 수 있다") {
            it("우승자는 한명일 수 있다") {
                ...
                val lapReports = listOf(
                    LapReport(
                        listOf(
                            CarNameWithLocation(winner, Location(0)),
                            CarNameWithLocation(CarName("참가자1"), Location(4)),
                            CarNameWithLocation(CarName("참가자2"), Location(3)),
                        )
                    ),
                    LapReport(
                        listOf(
            ...
            it("우승자는 한명 이상일 수 있다") {
                ...
                val lapReports = listOf(
                    LapReport(
                        listOf(
                            CarNameWithLocation(winner1, Location(39)),
                            CarNameWithLocation(winner2, Location(4)),
                            CarNameWithLocation(CarName("참가자"), Location(100))
                        )
                    ),
                    LapReport(
                        listOf(
                            CarNameWithLocation(winner1, Location(500)),
                            CarNameWithLocation(winner2, Location(500)),
                            CarNameWithLocation(CarName("참가자"), Location(200))
                        )
                    )
                )
